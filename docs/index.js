...
})({"fgJfw":[function(require,module,exports) {
...
var _edictor = require("edictor");
var _indexStyle = require("./index.style");
window.Model = (0, _edictor.Model);
window.ArrayOf = (0, _edictor.ArrayOf);
window.defineField = (0, _edictor.defineField);
...
},{"edictor":"hY895","./index.style":"5iB9F"}],"hY895":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "defineField", ()=>(0, _field.defineField));
parcelHelpers.export(exports, "Field", ()=>(0, _field.Field));
parcelHelpers.export(exports, "Model", ()=>(0, _model.Model));
parcelHelpers.export(exports, "update", ()=>(0, _model.update));
parcelHelpers.export(exports, "ArrayOf", ()=>(0, _arrayof.ArrayOf));
var _field = require("./edictor/field");
var _model = require("./edictor/model");
var _arrayof = require("./edictor/arrayof");

},{"./edictor/field":"fAuz6","./edictor/model":"ijkeD","./edictor/arrayof":"ajVqf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fAuz6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/** Error class to show when setting value doesn't pass validation. */ parcelHelpers.export(exports, "ValidateError", ()=>ValidateError);
/** Error class to show when required value is undefined */ parcelHelpers.export(exports, "RequiredError", ()=>RequiredError);
parcelHelpers.export(exports, "Field", ()=>Field);
parcelHelpers.export(exports, "DefineField", ()=>DefineField);
parcelHelpers.export(exports, "defineField", ()=>defineField);
...
class ValidateError extends Error {
    ...
    setErrors(errors) {
        this.errors = errors;
        const errors_ = [];
        for (const error of errors)errors_.push(`"${error.message}"`);
...
class Field {
    constructor(option = {}){
        this._validators = [];
        this._option = DefineField.defaultOption;
    ...
    _setOption(option = {}) {
        ...
        if (option.initial !== undefined) this.validate(option.initial);
        this._option = option;
    }
    get option() {
        return this._option;
    ...
    */ validate(value) {
        const errors = [];
        if (value === undefined) {
            /** Check required constrain. */ if (this.option.required) throw new RequiredError(`Field is required`);
            else return value;
        }
        /** Check with grant values to skip validations */ if (this._option.grant.includes(value)) return value;
        /** Validate and assign return value if undefined */ for (const validator of this.validators)try {
            const value_ = validator(value);
            if (value_) // Set value for next validator.
            value = value_;
        } catch (error) {
            errors.push(error);
        }
        if (errors.length > 0) throw new ValidateError().setErrors(errors);
        return value;
    }
}
class DefineField {
    static #_ = this.defaultOption = {
        required: false,
        initial: undefined,
        grant: []
    };
    constructor(option = {}, validators = []){
        this._option = DefineField.defaultOption;
        this._setOption(option);
        this._validators = [
            ...validators
     ...
     * ```
     */ instance(...types) {
        return new DefineField(this.option, [
            ...this.validators,
            _validator.instance(...types)
        ]);
    }
     ...
     * ```
     */ assert(func, msg = "Assertion error") {
        return new DefineField(this.option, [
            ...this.validators,
            _validator.assert(func, msg)
        ]);
    }
     ...
     */ model(model_class) {
        return new DefineField(this.option, [
            ...this.validators,
            _validator.model(model_class)
        ]);
    }
    /** Get Field() instance */ field(option = {}) {
        option = {
            ...this.option,
            ...option
        };
...
const defineField = (option = {})=>{
    return new DefineField(option);
};

},{"./validator":"hCLyt","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hCLyt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ValidationError", ()=>ValidationError);
/** Extends _ArrayOf to Support DefineField & Model */ parcelHelpers.export(exports, "ArrayOf", ()=>ArrayOf);
...
class ArrayOf extends (0, _arrayof.ArrayOf) {
    constructor(...validators){
        super(...validators);
    }
    _validate(value, validator) {
        if (validator instanceof (0, _field.DefineField)) {
            validator = validator.field();
            validator.validate(value);
            return;
        }
        if (validator.prototype instanceof (0, _model.Model)) {
            validator.validate(value);
            return;
        }
    ...
    validator_to_string(validator) {
        if (validator instanceof (0, _field.DefineField)) return `defineField({name: ${validator.field().name}})`;
        return super.validator_to_string(validator);
    }
}
const instance = (...types)=>{
    const wrapper = (value, types)=>{
        let valid = false;
        for (const type of types){
            /** When type is a class */ if (_util.is_class(type)) {
                if (value instanceof type) valid = true;
            }
            /** When type is primative. */ if (typeof type === "string") {
...
const regexp = (regexp_)=>{
    const wrapper = (value, regexp_)=>{
        if (!regexp_.test(value)) throw new ValidationError(`"${value}" doesn't pass Regular Expression => ${regexp_}`);
    };
    return function regexp(value) {
        wrapper(value, regexp_);
    };
};
const assert = (func, message = "")=>{
    const wrapper = (value, func, message = "")=>{
        if (!func(value)) {
            if (_util.is_function(message)) message = message(func, value);
            throw new ValidationError(message);
        }
    };
    return function assert(value) {
        wrapper(value, func, message);
    };
};
const apply = (func)=>{
    ...
    return function apply(value) {
        return wrapper(value, func);
    };
};
const arrayOf = (...validators)=>{
    /**  Return ArrayOf instance which can validate it's array. */ const wrapper = (values, validators)=>{
        if (!(values instanceof Array)) throw new ValidationError(`${values} is not iterable`);
        const array = new ArrayOf(...validators);
        array.set(...values);
    };
    return function arrayOf(values = []) {
        return wrapper(values, validators);
    };
};
const model = (model_class)=>{
    const wrapper = (value, model_class)=>{
        model_class.validate(value);
    };
    return function model(value) {
        return wrapper(value, model_class);
    };
};

},{"./util":"8HMZr","./field":"fAuz6","./model":"ijkeD","./arrayof":"ajVqf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8HMZr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/** Utility function to check if instance is a Function */ parcelHelpers.export(exports, "is_function", ()=>is_function);
/** Utility function to check if instance is a Class */ parcelHelpers.export(exports, "is_class", ()=>is_class);
parcelHelpers.export(exports, "AssertError", ()=>AssertError);
parcelHelpers.export(exports, "assert", ()=>assert);
function is_function(instance) {
    if (!(instance instanceof Function)) return false;
    const str = instance.toString();
    if (str.match(/^function/)) return true;
    if (str.match(/^\([\w\s,]*\)\s*\=\>\s*\{.*};?$/s)) return true;
    if (str.match(/^[\w\s]*\s*\=\>\s*\{.*};?$/s)) return true;
    return false;
}
function is_class(instance) {
    if (!(instance instanceof Function)) return false;
    if (instance.toString().match(/^class/)) return true;
    return false;
}
...
const assert = (expression, message = null)=>{
    if (message === null) message = `Expected expression to be true.`;
    if (expression === false) throw new AssertError(message);
};
...
},{}],"ijkeD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DefineError", ()=>DefineError);
parcelHelpers.export(exports, "PartialError", ()=>PartialError);
parcelHelpers.export(exports, "ValidateError", ()=>ValidateError);
parcelHelpers.export(exports, "InitError", ()=>InitError);
parcelHelpers.export(exports, "UpdateError", ()=>UpdateError);
parcelHelpers.export(exports, "DefineFieldError", ()=>DefineFieldError);
parcelHelpers.export(exports, "UndefinedError", ()=>UndefinedError);
parcelHelpers.export(exports, "SetValueError", ()=>SetValueError);
parcelHelpers.export(exports, "InputDataError", ()=>InputDataError);
parcelHelpers.export(exports, "Model", ()=>Model);
/** Atomic update data to object */ parcelHelpers.export(exports, "update", ()=>update);
var _field = require("./field");
class ModelError extends Error {
    /** return readable error object */ static errorInfo(error) {
        const errorInfo = {};
    ...
    /** Set error object */ setError(error) {
        this.error = error;
        this.errorInfo = ModelError.errorInfo(error);
        this.message += "\nYou can catch `error` then inspect `error.error` or `error.errorInfo` for more detail";
        this.message += "\n" + JSON.stringify(this.errorInfo, null, 4);
        return this;
    }
}
class DefineError extends ModelError {
    constructor(message = "Model definition contains error"){
        super(message);
        this.name = "DefineError";
    }
}
class PartialError extends ModelError {
    constructor(message = ""){
        super(message);
        this.name = "PartialError";
    }
}
class ValidateError extends ModelError {
    constructor(message = ""){
        super(message);
        this.name = "ValidateError";
    }
}
class InitError extends ModelError {
    constructor(message = ""){
        super(message);
        this.name = "InitError";
    }
...
class DefineFieldError extends Error {
    constructor(message = ""){
        super(message);
...
class SetValueError extends Error {
    constructor(message = ""){
        super(message);
...
class Model {
    static #_ = this._define = {};
    static #_1 = this._option = {
        strict: true
    };
    static define(model = {}, option = {}) {
        const superClass = Object.getPrototypeOf(this);
        if (superClass.name === "") throw new DefineError(`Model.define() is prohibited. ` + `It must be called from a subclass`);
        if (this._definedClass === this.name) throw new DefineError(`${this} has been defined.`);
        this._option = {
            ...superClass._option,
            ...option
        };
        ...
        for (let [key, defineField] of Object.entries(model)){
            /** Get Field() instance if value is DefineField() */ let field;
            if (defineField instanceof (0, _field.DefineField)) {
                field = defineField.field();
                if (field.name === undefined) field.name = key;
            } else {
                error[key] = new DefineFieldError(`Assigned value is not an instance of DefineField`);
                continue;
            }
            if (field.option.initial !== undefined) try {
                field.validate(field.option.initial);
            } catch (e) {
                error[key] = new DefineFieldError(`Field({initial: ${field.option.initial}})` + ` conflicts with Field's validation`);
            }
            model[key] = field;
        }
        if (Object.keys(error).length > 0) throw new DefineError().setError(error);
        this._define = {
            ...this._define,
            ...model
        };
    ...
    static _check_input_data(data) {
        if (data instanceof Array) throw new InputDataError(`new ${this.constructor.name}(data) => ` + `data must be an instance of object. Received Array`);
        if (!(data instanceof Object)) throw new InputDataError(`new ${this.constructor.name}(data) => ` + `data must be an instance of object, Received ${typeof data}`);
    }
    static test(data, option = {}) {
        this._check_input_data(data);
        /** Isolate received data */ data = {
            ...data
        };
        option = {
            ...this._option,
        ...
        /** If option {strict: true}, add errors as undefined fields */ if (option.strict === true) for (const key of Object.keys(data))result["error"][key] = new UndefinedError(`Field is undefined.`);
        else Object.assign(result["valid"], data);
        return result;
    }
    static partial(data, option = {}) {
        ...
        if (!data_keys.every((key)=>valid_keys.includes(key))) throw new PartialError().setError(result["error"]);
        return result["valid"];
    }
    static validate(data, option = {}) {
        const result = this.test(data, option);
        if (Object.keys(result["error"]).length > 0) throw new ValidateError().setError(result["error"]);
        return result["valid"];
    }
    constructor(data = {}, option = {}){
        ...
        try {
            ...
            if (error instanceof ModelError) throw new InitError().setError(error);
            throw error;
        }
        Object.assign(this, data);
        /** Setup Proxy */ const proxy = new Proxy(this, {
            get: (target, key, receiver)=>{
                return Reflect.get(target, key, receiver);
            },
            set: (target, key, value)=>{
                const field = _class.field[key];
                /** Check undefined field with Model()._option.strict */ if (field === undefined) {
                    if (target._option.strict) throw new SetValueError(`${target.constructor.name}()["${key}"] is not defined`);
                    else {
                        target[key] = value;
                        return true;
                    }
                }
                /** Validate value => Throw FieldValidateError is invalid */ try {
                    value = field.validate(value);
                } catch (error) {
                    if (error instanceof (0, _field.ValidateError)) throw new SetValueError(`\`[${key}] = ${value}\` is invalid`);
                    throw error;
                }
            ...
            ownKeys (target) {
                /** Remove protected _option */ return Object.keys(target).filter((item)=>item != "_option");
            }
        });
        return proxy;
    }
...
function update(obj, data) {
    ...
    try {
        ...
        if (error instanceof ModelError) throw new UpdateError().setError(error.error);
    }
    Object.assign(obj, data);
}

},{"./field":"fAuz6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ajVqf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ErrorObject", ()=>ErrorObject);
parcelHelpers.export(exports, "SetError", ()=>SetError);
parcelHelpers.export(exports, "PushError", ()=>PushError);
parcelHelpers.export(exports, "SetValueError", ()=>SetValueError);
parcelHelpers.export(exports, "ValidationError", ()=>ValidationError);
/** Modified array which check it's members instance. */ parcelHelpers.export(exports, "ArrayOf", ()=>ArrayOf);
var _util = require("./util");
...
class SetError extends ErrorObject {
    constructor(message = ""){
        super(message);
        this.name = "SetError";
    }
}
class PushError extends ErrorObject {
    constructor(message = ""){
        super(message);
        this.name = "PushError";
    }
...
class ArrayOf extends Array {
    constructor(...validators){
        super();
        /** propery to keep validators */ this._validators = [];
        ...
        return new Proxy(this, {
            ...
            set (target, key, value, receiver) {
                if (key === "length") return Reflect.set(target, key, receiver);
                try {
    ...
    /** validate a value with a validator */ _validate(value, validator) {
        // If validator is a primative type.
        if (typeof validator === "string") {
            (0, _util.assert)(typeof value === validator, `${value} => must be instance of ${validator}`);
            return;
        }
        if (validator instanceof Array) {
            (0, _util.assert)(value instanceof Array, `value must be instance of Array`);
            const array = new ArrayOf(...validator);
            array.set(...value);
            return;
        }
        // If validator is a Function
        if ((0, _util.is_function)(validator)) validator(value);
        // If validator is a Class
        if ((0, _util.is_class)(validator)) {
            (0, _util.assert)(value instanceof validator);
            return;
        }
    }
    /** validate a value */ _validate_value_with_validators(value, validators = this.validators) {
        validators = [
            ...validators
        ];
        ...
        if (value_pass_once) return value_;
        throw new ValidationError(`Expect ArrayOf(${this.validators_to_string(validators)})`);
    }
    validators_to_string(validators = this.validators) {
        validators = [
            ...validators
        ];
    ...
    validator_to_string(validator) {
        if (validator instanceof Array) return `[${this.validators_to_string(validator)}]`;
        if ((0, _util.is_function)(validator)) return `${validator.name}()`;
        if ((0, _util.is_class)(validator)) return validator.name;
        if (typeof validator === "string") return `"${validator}"`;
    }
    _push_skip_proxy(...values) {
    ...
    set(...values) {
        ...
        if (Object.keys(result["error"]).length > 0) throw new SetError().setError(result["error"]);
        this.length = 0;
    ...
    push(...values) {
        ...
        const result = this.test(values);
        if (Object.keys(result["error"]).length > 0) throw new PushError().setError(result["error"]);
        return this._push_skip_proxy(...Object.values(result["valid"]));
    }
    /** Return a new native object with same data */ object() {
        const object = [
            ...this
        ];
        return object;
...
},{"./util":"8HMZr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5iB9F":[function(require,module,exports) {
...
#header {
    ...
    button[el="guide"] {
        ${(0, _gadjet.bgColorInt)({
    color: (0, _color.theme).purple2
})}
    }
...
},{"gadjet/src/gadjet":"2SrWz","./_color":"lFBda"}],"2SrWz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Adapter extends HTMLElement {
    static #_ = this.Style = StyleClass;
    static get tagName() {
    ...
    static #_1 = this.max_id = Math.pow(16, 4) - 1;
    static #_2 = this.instance = {};
    static _generate_id() {
...
},{"71b6e3b39cf59f9f":"d9oJb","c094f2fb379d5867":"6uFtr"}],"d9oJb":[function(require,module,exports) {
...
const conversions = require("6663911e9245af69");
const route = require("2726cbcae99c335b");
const convert = {};
...
},{"6663911e9245af69":"lE0pm","2726cbcae99c335b":"fuMRz"}],"lE0pm":[function(require,module,exports) {
/* MIT license */ /* eslint-disable no-mixed-operators */ const cssKeywords = require("7de42b7de951386e");
...
},{"7de42b7de951386e":"e6EtS"}],"e6EtS":[function(require,module,exports) {
"use strict";
module.exports = {
    "aliceblue": [
        240,
...
const conversions = require("b3ae1485254efca");
/*
...
},{"b3ae1485254efca":"lE0pm"}],"ckzzz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Badge extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _badgeStyle.BadgeStyle);
    static tagStyle(style) {
...
class BoxArrow extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _boxArrowStyle.BoxArrowStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Button extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _buttonStyle.ButtonStyle);
    static #_1 = this.tagName = "button";
    static define(tagName) {
...
class ButtonGroup extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _buttonGroupStyle.ButtonGroupStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class ButtonPin extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _buttonPinStyle.ButtonPinStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class ButtonSquare extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _buttonSquareStyle.ButtonSquareStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Card extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _cardStyle.CardStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Checkbox extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _checkboxStyle.CheckboxStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Input extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _inputStyle.InputStyle);
}
(0, _adapter.addStyle)`
input {
...
class InputDate extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _inputDateStyle.InputDateStyle);
    constructor(){
        super();
...
class InputNumber extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _inputNumberStyle.InputNumberStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class InputNumberCenter extends (0, _inputNumber.InputNumber) {
    static #_ = this.Style = (0, _inputNumberCenterStyle.InputNumberCenterStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class InputRadio extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _inputRadioStyle.InputRadioStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class InputTag extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _inputTagStyle.InputTagStyle);
    static define(tagName) {
...
class TagX extends (0, _tag.Tag) {
    static #_ = this.Style = (0, _tagxStyle.TagXStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Tag extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _tagStyle.TagStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Menu extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _menuStyle.MenuStyle);
    constructor(){
        super();
...
class ProgressBar extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _progressBarStyle.ProgressBarStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class ProgressCircle extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _progressCircleStyle.ProgressCircleStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Sidebar extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _sidebarStyle.SidebarStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Switch extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _switchStyle.SwitchStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Tab extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _tabStyle.TabStyle);
    static tagStyle(style) {
        super.tagStyle(style);
    }
    static classStyle(class_, style) {
...
class Table extends (0, _adapter.Adapter) {
    static #_ = this.Style = (0, _tableStyle.TableStyle);
    static #_1 = this.tagName = "table";
    static define(tagName) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fgJfw","kD2es"], "kD2es", "parcelRequire043e")

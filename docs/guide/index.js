...
})({"476hy":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "105508e66baadf66";
"use strict";
...
},{}],"k0o2g":[function(require,module,exports) {
var _indexStyle = require("./index.style");
/** ES Module */ var _edictor = require("edictor");
/** Every defined model class must extended from `Model` */ class Package extends (0, _edictor.Model) {
}
class People extends (0, _edictor.Model) {
}
 ...
 */ const urlDef = (0, _edictor.defineField)().instance("string").apply((value)=>{
    new URL(value);
});
/** Define `People` schema
 * - definedField() can be used directly as a schema's field.
*/ People.define({
    name: (0, _edictor.defineField)({
        required: true
    }).instance("string"),
    email: (0, _edictor.defineField)().instance("string").regexp(/^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$/),
    url: urlDef // Reuseable `urlDef`
});
/** Define `Package` schema */ Package.define({
    name: (0, _edictor.defineField)({
        required: true
    }).instance("string").assert((value)=>{
        return value.length <= 214;
    }, "The name must be less than or equal to 214 characters"),
    version: (0, _edictor.defineField)({
        required: true
    }).instance("string").regexp(/^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)(?:-((?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*)(?:\.(?:0|[1-9]\d*|\d*[a-zA-Z-][0-9a-zA-Z-]*))*))?(?:\+([0-9a-zA-Z-]+(?:\.[0-9a-zA-Z-]+)*))?$/),
    homepage: urlDef,
    author: (0, _edictor.defineField)().model(People),
    contributors: (0, _edictor.defineField)({
        initial: []
    }) // Set initial data for calling `push()`
    .arrayOf(People)
});
...
/** Schema validation */ Package.validate({
    "name": "edictor",
    "version": "0.4.0",
    "homepage": "https://nitipit.github.io/edictor/"
});
/** Atomic Instance */ const pk = new Package({
    "name": "edictor",
    "version": "0.5.0"
});
pk["version"] = "0.5.1";
/** Validations */ // Data is valid
Package.validate({
    name: "test-package",
    version: "0.0.1"
});
...
},{"./index.style":"5XOoZ","edictor":"hY895"}],"5XOoZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _style = require("gadjet/src/style");
var _color = require("color");
var _colorDefault = parcelHelpers.interopDefault(_color);
var _color1 = require("../_color");
(0, _style.addStyle)`
body {
    ${(0, _style.bgColor)(new (0, _colorDefault.default)((0, _color1.theme).yellow).lighten(0.2).toString())}
}
...
#guide {
    ...
    h1 {
        ...
        text-align: center;
        a {
            color: ${(0, _color1.theme).purple2};
            text-decoration: none;
        }
    }
    h2 {
        color: ${(0, _color1.theme).purple2};
        border-bottom: 2px dashed ${(0, _color1.theme).purple2};
    }
...
},{"gadjet/src/style":"72rKO","color":"gW2oi","../_color":"lFBda","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"72rKO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lFBda":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hY895":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ijkeD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./util":"8HMZr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["476hy","k0o2g"], "k0o2g", "parcelRequire043e")

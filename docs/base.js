...
})({"bVOhl":[function(require,module,exports) {
...
var _shellDefault = parcelHelpers.interopDefault(_shell);
...
var _atomOneDarkReasonableCss = require("highlight.js/styles/atom-one-dark-reasonable.css");
var _gadjet = require("gadjet/src/gadjet");
var _icon = require("@nitipit/icon/src/icon");
var _baseStyle = require("./base.style");
var _adapter = require("@nitipit/adapter/src/adapter");
var _color = require("./_color");
class TitleCode extends (0, _adapter.Adapter) {
}
...
TitleCode.tagStyle(`
    ...
    font-size: 0.8rem;
    font-weight: bold;
    ${(0, _gadjet.bgColor)((0, _color.theme).yellow)}
`);
class TitleBlockquote extends (0, _adapter.Adapter) {
}
...
TitleBlockquote.tagStyle(`
    ...
    font-size: 0.8rem;
    font-weight: bold;
    ${(0, _gadjet.bgColor)((0, _color.theme).purple3)}
`);
...
(0, _coreDefault.default).registerLanguage("shell", (0, _shellDefault.default));
(0, _coreDefault.default).registerLanguage("typescript", (0, _typescriptDefault.default));
(0, _coreDefault.default).registerLanguage("html", (0, _xmlDefault.default));
(0, _coreDefault.default).highlightAll();
(0, _icon.Icon).href = `${_base_url}asset/icomoon/symbol-defs.svg`;
customElements.define("el-icon", (0, _icon.Icon));
(0, _gadjet.Button).define("button");
(0, _gadjet.Button).tagStyle({
    color: "#f5c211"
});
(0, _gadjet.Button).classStyle("gray", {
    color: "#deddda"
});
(0, _gadjet.ButtonSquare).define("el-button-square");

},{"highlight.js/lib/core":"gPJXT","highlight.js/lib/languages/javascript":"hqLug","highlight.js/lib/languages/shell":"lVpJt","highlight.js/lib/languages/typescript":"aMCSl","highlight.js/lib/languages/xml":"aCAoh","highlight.js/styles/atom-one-dark-reasonable.css":"fl04K","gadjet/src/gadjet":"2SrWz","@nitipit/icon/src/icon":"kGjpc","./base.style":"exCNa","@nitipit/adapter/src/adapter":"1Fra8","./_color":"lFBda","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gPJXT":[function(require,module,exports) {
...
},{}],"fl04K":[function() {},{}],"2SrWz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@nitipit/adapter/src/adapter":"1Fra8","../../style":"72rKO","cd24947c88618007":"gW2oi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kGjpc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"exCNa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _gadjet = require("gadjet/src/gadjet");
var _color = require("color");
var _colorDefault = parcelHelpers.interopDefault(_color);
...
pre > code.hljs {
    ...
    border-left: 0.3rem solid ${(0, _color1.theme).yellow};
}
...
code {
    ...
    ${(0, _gadjet.bgColor)(new (0, _colorDefault.default)((0, _color1.theme).purple2).lighten(0.3).toString())}
}
...
blockquote {
    margin: 0;
    padding-left: 1rem;
    border-left: 0.4rem solid ${(0, _color1.theme).purple3};
    border-radius: 1rem;
    border-top-left-radius: 0;
    box-sizing: border-box;
    ${(0, _gadjet.bgColor)(new (0, _colorDefault.default)((0, _color1.theme).purple3).lighten(0.5).toString())}
    ul {
        padding-left: 1rem;
        padding-top: 0.5rem;
        padding-bottom: 0.5rem;
...
},{"gadjet/src/gadjet":"2SrWz","color":"gW2oi","./_color":"lFBda","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lFBda":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bVOhl","7H2eR"], "7H2eR", "parcelRequire043e")

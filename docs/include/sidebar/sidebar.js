...
})({"6Z7yz":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7261ea89990616b6";
"use strict";
...
},{}],"aFxXe":[function(require,module,exports) {
...
(0, _gadjet.ButtonPin).define("el-sidebar-button");
(0, _gadjet.ButtonPin).tagStyle({
...
(0, _gadjet.ButtonPin).tagStyle(`
    ...
    z-index: 100;
`);
(0, _gadjet.Menu).define("el-sidebar-menu");
(0, _gadjet.Menu).tagStyle({
    bgColor: (0, _color1.theme).purple3
});
(0, _gadjet.Menu).tagStyle(`
    border-radius: 0;
    border: 0;
    ...
    color: new (0, _colorDefault.default)((0, _color1.theme).purple3).lighten(0.5).toString(),
    lighten: -0.2
})}
        text-decoration: none;
    }
`);
(0, _gadjet.Sidebar).define("el-sidebar");
(0, _gadjet.Sidebar).tagStyle({
    bgColor: new (0, _colorDefault.default)((0, _color1.theme).purple3).lighten(0.5).toString(),
    overlayColor: new (0, _colorDefault.default)((0, _color1.theme).purple3).darken(0.8).fade(0.2).toString()
});
(0, _gadjet.Sidebar).tagStyle(`
    div[el="header"] {
        display: flex;
        ...
        ${(0, _gadjet.aspectRatio)("3/2")}
        ${(0, _gadjet.bgColor)(new (0, _colorDefault.default)((0, _color1.theme).purple2).lighten(0.2).toString())}
        a {
            color: inherit;
            text-decoration: none;
        }
...
document.querySelector((0, _gadjet.ButtonPin).tagName).addEventListener("click", ()=>{
    window.sidebar.show();
});
document.querySelector(`el-sidebar-menu`).addEventListener("click", (event)=>{
    if (window.matchMedia("(min-width: 1190px").matches) {
        console.log("matched");
        return;
    }
    const target = event.target;
    if (target.tagName.toLowerCase() === "a") setTimeout(()=>{
        window.sidebar.hide();
    }, 250);
});

},{"color":"gW2oi","gadjet/src/gadjet":"2SrWz","../../_color":"lFBda","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gW2oi":[function(require,module,exports) {
...
},{"b3ae1485254efca":"lE0pm"}],"2SrWz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"f6bcff9cde63c78a":"gW2oi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ckzzz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6Z7yz","aFxXe"], "aFxXe", "parcelRequire043e")
